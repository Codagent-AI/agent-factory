...
Named fields and options describe the initial Codagent configuration and SHALL be mapped through configuration. The eval work kind and suite integration SHALL supply eval-specific scores, revision displays, outcome details, and human-review commands. Durable GitHub delivery SHALL not assume all work kinds produce those details.
